...
<body>
  ...
  <ul>
	<li><html:link module="/attacks" action="/unsecure/attacks">Vulnerable Example Section</html:link></li>
	
	<li><html:link module="/attacks" action="/secure/attacks">Vulnerable Example Section resolved by HDIV</html:link></li>	
  ...
  <h2><html:link module="/attacks" page="/unsecure/attacks.do">Vulnerable Example Section</html:link></h2>
  <p>This section is a demonstration of common web application flaws. These exercises show how easily can 
  penetration techniques be applied.</p>
  
  <h2><html:link module="/attacks" page="/secure/attacks.do">Vulnerable Example Section resolved by HDIV</html:link></h2>
  <p>This section is a demonstration of common web application flaws but they are resolved by HDIV.</p>  
